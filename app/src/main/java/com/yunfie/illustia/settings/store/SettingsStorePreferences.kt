...
internal fun readFromDataStore(
    ...
    return AppSettings(
        ...
        showRelatedR18 = preferences[SHOW_RELATED_R18] ?: true,
        ...
        illustDetailQuality = preferences[ILLUST_DETAIL_QUALITY] ?: "medium",
        ...
        liveWallpaperSource = preferences[LIVE_WALLPAPER_SOURCE] ?: "all",
        liveWallpaperSourceFolder = preferences[LIVE_WALLPAPER_SOURCE_FOLDER].orEmpty(),
        liveWallpaperChangeMode = preferences[LIVE_WALLPAPER_CHANGE_MODE] ?: "screen",
        liveWallpaperIntervalMinutes = (preferences[LIVE_WALLPAPER_INTERVAL_MINUTES] ?: 60).coerceIn(15, 1440),
        liveWallpaperOrder = preferences[LIVE_WALLPAPER_ORDER] ?: "random",
        liveWallpaperScaleMode = preferences[LIVE_WALLPAPER_SCALE_MODE] ?: "cover",
        liveWallpaperBackground = preferences[LIVE_WALLPAPER_BACKGROUND] ?: "black",
        liveWallpaperCrossfade = preferences[LIVE_WALLPAPER_CROSSFADE] ?: true,
        liveWallpaperExcludeSensitive = preferences[LIVE_WALLPAPER_EXCLUDE_SENSITIVE] ?: true,
        accounts = accounts,
        ...
        dummyAppName = preferences[DUMMY_APP_NAME].orEmpty(),
...
internal fun readFromSharedPreferences(preferences: SharedPreferences): AppSettings =
    AppSettings(
        ...
        showRelatedR18 = preferences.getBoolean("showRelatedR18", true),
...
internal fun writeToDataStore(
    ...
    preferences[SHOW_RELATED_R18] = settings.showRelatedR18
    ...
    preferences[LIVE_WALLPAPER_SOURCE_FOLDER] = settings.liveWallpaperSourceFolder
    preferences[LIVE_WALLPAPER_CHANGE_MODE] = settings.liveWallpaperChangeMode
    preferences[LIVE_WALLPAPER_INTERVAL_MINUTES] = settings.liveWallpaperIntervalMinutes
    preferences[LIVE_WALLPAPER_ORDER] = settings.liveWallpaperOrder
    preferences[LIVE_WALLPAPER_SCALE_MODE] = settings.liveWallpaperScaleMode
    preferences[LIVE_WALLPAPER_BACKGROUND] = settings.liveWallpaperBackground
    preferences[LIVE_WALLPAPER_CROSSFADE] = settings.liveWallpaperCrossfade
    preferences[LIVE_WALLPAPER_EXCLUDE_SENSITIVE] = settings.liveWallpaperExcludeSensitive
